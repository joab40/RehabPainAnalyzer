...
#fname = cbook.get_sample_data('/media/storage/joab40/git/rehab_new_andriod/matplot/msft.csv.org', asfileobj=True)
#fname = cbook.get_sample_data('./msft.csv', asfileobj=True)
